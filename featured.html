  ...
  <section class="products" id="unfiltered">
    ...
    <div id="pr1" class="prod" >
      <div id="top" class="men top s">
        ...
        <div class="inf"><h2>black jacket</h2>
        <h2>50.00$</h2>
        </div>
        <div id="sec2">
      ...
      <div id="bottoms" class="women bottoms l">
        ...
        <div class="inf"><h2>Blue Pants</h2>
        <h2>50.00$</h2>
      </div>
        <div id="sec2">
                  ...
                  <div id="sec2">
                    ...
                    <div id="po">
                      ...
                      <div id="pr8" class="prod" >
                        ...
                        <div class="inf"><h2>short sleve shirt</h2>
                        <h2>90.00$</h2>
                      </div>
                        <div id="sec2">
                          ...
                          <div id="po">
                            ...
                            <div id="pr9" class="prod" >
                              ...
                              <div class="inf"><h2>Palazzo pants</h2>
                              <h2>110.00$</h2>
                            </div>
                              <div id="sec2">
                                ...
                                <div id="po">
                                  ...
                                  <div id="pr10" class="prod" >
                                    ...
                                    <div class="inf"><h2>yellow jacket</h2>
                                    <h2>70.00$</h2>
                                  </div>
                                    <div id="sec2">
