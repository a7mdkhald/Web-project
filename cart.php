        ...
        <table width="80%">
            ...
            <tbody>
                ...
                for ($i = 1; $i <= 10; $i++) {
                    ...
                    </td><td><img src="' . $_SESSION[$imgstr] . '" alt="d" style="height: 100px; width: 100px;"></img>  </td><td>' . $_SESSION[$nmstr] . '</td>
                    <td>' . $_SESSION[$prstr] . '</td>
                    <td>  ' . $_SESSION[$prstr] . '</td></tr>';
                        $totalsum = $totalsum + $_SESSION[$prstr];
                        $tbset = 1;
                    }
                }
                ?>
