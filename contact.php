...
<section id="content">
            ...
            <div class="head"><h1 class="hedf">Contact Us</h1>
            <div id="parg"><p>Feel Free To Send Us Your Feedback,Suggestions Or Complaints</p></div></div>
                ...
                <div class="form-group">
                    <form name="contactform" action="" class="contact" onsubmit="submission()">
            ...
            <ul id="info-list">
                ...
                <li> <img src="buildings.png" width="30px" height="30px" alt=""> <p id="strt">13,el-mosher st.,sidi gaber</p></li>
                <li> <img src="clock.png" alt="" width="30px" height="30px" id="clock"><p id="clck">9:00 - 18:00</p></li>
            </ul>
            </div>
            <div id="socials">
               <div id="sch2"> <h2>Social Media</h2></div>
